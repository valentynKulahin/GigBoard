...
class GigRepository @Inject constructor() {
    ...
    private fun time(hour: Int, minute: Int): Long =
    ...
    fun getTrips(): List<Trip> = listOf(
        ...
        Trip(1, GigPlatform.UBER, TripType.VERIFIED,
            "Midtown area", "Downtown area",
            time(8,12), time(8,41),
            7.2, 18.50,
            listOf(
                LatLng(29.755, -95.36),
        ...
        Trip(2, null, TripType.OFF_TRIP,
            "Downtown area", "East side",
            time(8,41), time(8,58),
            3.1, 0.0,
            listOf(
                LatLng(29.74, -95.34),
                LatLng(29.737, -95.335),
                LatLng(29.735, -95.33)
            )
        ),

        Trip(3, GigPlatform.DOORDASH, TripType.VERIFIED,
            "Restaurant district", "Residential area",
            time(8,58), time(9,14),
            4.3, 8.75,
            listOf(
                LatLng(29.735, -95.33),
                LatLng(29.733, -95.335),
                LatLng(29.73, -95.34)
            )
        ),

        Trip(4, GigPlatform.DOORDASH, TripType.VERIFIED,
            "Restaurant district", "West side",
            time(9,18), time(9,35),
            5.1, 11.20,
            listOf(
                LatLng(29.733, -95.34),
                LatLng(29.731, -95.345),
                LatLng(29.73, -95.35)
            )
        ),

        Trip(5, null, TripType.OFF_TRIP,
            "West side", "Warehouse district",
            time(9,35), time(9,52),
            6.8, 0.0,
            listOf(
                LatLng(29.73, -95.35),
                LatLng(29.725, -95.365),
                LatLng(29.72, -95.38)
            )
        ),

        Trip(6, GigPlatform.AMAZON_FLEX, TripType.VERIFIED,
            "Warehouse district", "Delivery zone (12 stops)",
            time(10,10), time(13,15),
            38.6, 89.40,
            listOf(
                LatLng(29.72, -95.38),
                LatLng(29.71, -95.36),
        ...
        Trip(7, null, TripType.OFF_TRIP,
            "South area", "Home zone",
            time(13,15), time(13,38),
            8.4, 0.0,
            listOf(
                LatLng(29.705, -95.39),
                LatLng(29.73, -95.38),
        ...
        Trip(8, GigPlatform.UBER, TripType.VERIFIED,
            "Airport area", "Downtown area",
            time(15,35), time(16,12),
            18.3, 42.80,
            listOf(
                LatLng(29.78, -95.34),
                LatLng(29.77, -95.345),
        ...
        Trip(9, GigPlatform.LYFT, TripType.VERIFIED,
            "Downtown area", "Suburb heights",
            time(16,18), time(16,52),
            14.7, 32.60,
            listOf(
                LatLng(29.75, -95.36),
                LatLng(29.745, -95.375),
                LatLng(29.74, -95.39)
            )
        ),
    )
